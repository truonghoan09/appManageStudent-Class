                ...
                <div className={styles.containerBox}>
                    ...
                    <div className={styles.body}>
                        <div className={styles.containerBody}>
                            Are you sure you want to delete the data for {deleteItem}?
                        </div>
                    </div>
                    <div className={styles.footer}>
                        <div className={styles.cancelBtn} onClick={() => {closeFunc()}}>Cancel</div>
                        <div className={styles.deleteBtn} onClick={() => {deleteFunc()}}>Delete</div>
                    </div>
